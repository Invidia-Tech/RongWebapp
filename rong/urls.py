...
urlpatterns = [
    ...
    path('api/get_members/', api.gearbot_get_members, name='api_gearbot_get_members'),
    ...
    path('clan/<slug:clan>/battles/<int:battle_id>/editcomp/<int:comp_id>/', manageclan.edit_comp,
         name='clan_edit_comp'),
    path('clan/<slug:clan>/battles/<int:battle_id>/addcomp/', manageclan.add_comp, name='clan_add_comp'),
    path('clan/<slug:clan>/battles/<int:battle_id>/editgroup/<int:group_id>/', manageclan.edit_hit_group,
         name='clan_edit_hit_group'),
    ...
    path('clanbattle/<slug:battle>/hits/csv/', clanbattle.hit_log_csv, name='cb_list_hits_csv'),
